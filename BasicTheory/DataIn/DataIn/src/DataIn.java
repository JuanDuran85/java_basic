package BasicTheory.DataIn.DataIn.src;
...
public class DataIn {
    ...
    static final Logger logger = Logger.getLogger(DataIn.class.getName());
    ...
    public static void main(String[] args) {
        ...
        // The nextLine() method returns a string containing all the characters up
        ...
        // The nextLine() method returns a string containing all the characters up to
